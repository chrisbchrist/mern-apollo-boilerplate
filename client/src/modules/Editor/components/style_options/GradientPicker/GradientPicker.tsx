...
export const GradientPicker: FunctionComponent = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="gradients__preview-wrapper">
          {selectedGradient && (
            <div
          ...
          <div className="gradients__options">
            {gradients.slice(0, 12).map((gradient: Gradient, i: number) => {
              const colors = formatColors(gradient.colors);
              return (
                <div
                  ...
                  onClick={() => setSelectedGradient(gradients[i])}
                >
